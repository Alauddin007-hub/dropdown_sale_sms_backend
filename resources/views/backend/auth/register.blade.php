        ...
        <form action="{{ route('register') }}" method="post">
          ...
          <div class="input-group mb-3">
            <select class="form-control" name="user_type" id="">
              ...
              <option value="0" {{ old('user_type') == 0 ? 'selected' : '' }}>Super Admin</option>
              <option value="1" {{ old('user_type') == 1 ? 'selected' : '' }}>Admin</option>
              <option value="2" {{ old('user_type') == 2 ? 'selected' : '' }}>NormalUser</option>
            </select>
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-solid fa-user-tie"></span>
